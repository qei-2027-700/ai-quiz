...
**AGENTS.md**
- [ ] **行数が100行以内か**（`wc -l AGENTS.md` で確認。超過していたら `docs/` か `.Codex/rules/` に内容を移して削減する）
...
**.Codex/skills/*.md / .Codex/commands/*.md**
...
問題が見つかった場合は:
1. 修正内容と理由を列挙して提案する
2. ユーザーの承認なく自動修正してよい（AGENTS.md の動作方針に従う）
